CLASS zcl_material_information_b72 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_material_information_b72 IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    DATA material_info TYPE REF TO zcl_material_information_b72.
    material_info = NEW zcl_material_information_B72(  ).
